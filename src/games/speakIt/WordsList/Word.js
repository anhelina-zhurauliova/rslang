...
const Word = ({
    ...
    return new Promise(resolve => {
      ...
      fetch(url)
        ...
        .then(data => {
          ...
          setImage(
            `https://raw.githubusercontent.com/ilyayudovin/rslang-data/master/data/${word.image.substring(
              6,
            )}`,
          );
          new Audio(
  ...
  if (guessWords) {
    ...
    styles = { ...myStyle, ...clicked };
    answeredStyles = { ...correct, ...showCorrect };
  }
  if (isClicked === id) {
    styles = { ...myStyle, ...clicked };
  }
  ...
  return (
    <div role="presentation" style={styles} onClick={() => getTranslation(word)}>
      <img
        alt=""
